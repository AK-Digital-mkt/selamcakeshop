  ...
  return (
    <>
      <div className={"loader" + (loaderHidden ? " hidden" : "")} id="loader" aria-hidden="true">
        <div className="loader-inner">
          <div className="loader-mark">
            <svg width="72" height="72" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ animation: "loader-pulse 1.6s ease-in-out infinite" }}>
              {/* Paintbrush handle */}
              <g fill="white">
                {/* Handle - wooden part */}
                <path d="M 180 200 Q 170 250 165 280 Q 163 290 175 290 Q 187 290 185 280 Q 180 250 190 200 Z" stroke="white" strokeWidth="8" fill="none" strokeLinecap="round" />
                
                {/* Brush bristles */}
                <ellipse cx="185" cy="190" rx="28" ry="35" fill="white" opacity="0.95" />
                <path d="M 160 180 Q 155 170 157 160 M 170 175 Q 165 160 168 150 M 185 172 Q 180 155 183 145 M 200 175 Q 195 160 198 150 M 210 180 Q 205 170 207 160" stroke="white" strokeWidth="6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                
                {/* Ferrule (metal part) */}
                <ellipse cx="185" cy="148" rx="32" ry="8" fill="white" />
                <ellipse cx="185" cy="146" rx="30" ry="6" fill="white" opacity="0.8" />
              </g>

              {/* "Selam Plates" text */}
              <text x="200" y="120" fontFamily="cursive" fontSize="48" fill="white" fontWeight="normal" textAnchor="middle" style={{ transform: "scaleX(0.9)" }}>
                Selam
              </text>
              
              {/* "CAKE ART" text */}
              <text x="200" y="155" fontFamily="sans-serif" fontSize="20" fill="white" fontWeight="700" textAnchor="middle" letterSpacing="8">
                CAKE ART
              </text>
            </svg>
          </div>
      ...
      <nav className="nav">
        {(
          [
            ["home", "navHome", <svg key="h" className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="19" height="19"><path d="M3 11l9-8 9 8v10a2 2 0 01-2 2h-2v-6a2 2 0 00-2-2h-2a2 2 0 00-2 2v6H5a2 2 0 01-2-2z" /></svg>],
            ["payment", "navPay", <svg key="p" className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="19" height="19"><rect x="2" y="6" width="20" height="14" rx="2" /><path d="M2 11h20" /></svg>],
          ] as const
        ).map(([id, key, icon]) => (
