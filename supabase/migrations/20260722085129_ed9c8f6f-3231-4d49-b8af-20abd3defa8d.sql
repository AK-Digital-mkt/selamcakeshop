...
CREATE POLICY "Admin view orders" ON public.orders FOR SELECT TO authenticated USING (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin upd orders" ON public.orders FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin')) WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin del orders" ON public.orders FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'));
CREATE TRIGGER update_orders_updated_at BEFORE UPDATE ON public.orders FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

CREATE POLICY "Admin up cake imgs" ON storage.objects FOR INSERT TO authenticated WITH CHECK (bucket_id = 'cake-images' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin update cake imgs" ON storage.objects FOR UPDATE TO authenticated USING (bucket_id = 'cake-images' AND public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin del cake imgs" ON storage.objects FOR DELETE TO authenticated USING (bucket_id = 'cake-images' AND public.has_role(auth.uid(), 'admin'));
...
CREATE POLICY "Admin ins sia" ON public.shop_item_availability FOR INSERT TO authenticated WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin upd sia" ON public.shop_item_availability FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin')) WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admin del sia" ON public.shop_item_availability FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'));
...
INSERT INTO public.shop_items (id, name, sub, cat, price, img, sort_order, available_today) VALUES
('fast1','Fruit & Nut Fasting Cake','Mixed dried fruits · Walnuts · Spiced batter · No dairy','mini-cake',35,'https://images.pexels.com/photos/37661106/pexels-photo-37661106.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('fast2','Vegan Chocolate','Rich cocoa · Coconut milk · Dairy-free ganache','mini-cake',38,'https://images.pexels.com/photos/37262561/pexels-photo-37262561.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('fast3','Apple Cinnamon','Fresh apples · Cinnamon spice · Oat crumble topping','mini-cake',32,'https://images.pexels.com/photos/30739085/pexels-photo-30739085.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('fast4','Carrot Walnut','Grated carrots · Walnuts · Orange zest · Plant-based cream','mini-cake',34,'https://images.pexels.com/photos/32397279/pexels-photo-32397279.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('ker1','Baptism Cross Cake','White vanilla · Gold cross · Soft buttercream','christening',45,'https://images.pexels.com/photos/2144200/pexels-photo-2144200.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('ker2','Holy Communion Cake','Elegant white · Host detail · Floral accents','christening',55,'https://images.pexels.com/photos/32437628/pexels-photo-32437628.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('ker3','Easter Resurrection Cake','Chocolate layers · Spring florals · Symbolic design','christening',48,'https://images.pexels.com/photos/31336127/pexels-photo-31336127.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('ker4','Confirmation Blessing','Light sponge · Pastel frosting · Dove decoration','christening',42,'https://images.pexels.com/photos/15307373/pexels-photo-15307373.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('ysh1','Traditional Shemgelena','Honey bread base · Decorative icing · Cultural motifs','baby-shower',40,'https://images.pexels.com/photos/29051739/pexels-photo-29051739.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('ysh2','Blue Baby Welcome','Vanilla sponge · Blue buttercream · Teddy topper','baby-shower',38,'https://images.pexels.com/photos/30233124/pexels-photo-30233124.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('ysh3','Pink Baby Shower','Strawberry cream · Pink roses · Edible pearls','baby-shower',38,'https://images.pexels.com/photos/12742498/pexels-photo-12742498.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('ysh4','Neutral Woodland','Earthy tones · Forest animals · Gender-neutral design','baby-shower',42,'https://images.pexels.com/photos/30233124/pexels-photo-30233124.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('grad1','Cap & Gown Tier','2-tier chocolate · Graduation cap topper · Gold details','graduation',65,'https://images.pexels.com/photos/9540405/pexels-photo-9540405.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('grad2','Diploma Scroll','Vanilla roll design · Edible ribbon · Personalised name','graduation',50,'https://images.pexels.com/photos/20768168/pexels-photo-20768168.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('grad3','Class of 2026','Modern design · School colours · Year banner','graduation',58,'https://images.pexels.com/photos/12419449/pexels-photo-12419449.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('grad4','Scholar Book Stack','Stacked book design · Fondant finish · Quote plaque','graduation',55,'https://images.pexels.com/photos/6210746/pexels-photo-6210746.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('wed1','3-Tier Floral Wedding','Vanilla sponge · Buttercream roses · Fresh greenery','wedding',220,'https://images.pexels.com/photos/34569681/pexels-photo-34569681.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('wed2','Anniversary Gold','Golden fondant · Champagne accents · Sugar flowers','wedding',95,'https://images.pexels.com/photos/34073612/pexels-photo-34073612.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('wed3','Silver Jubilee','Silver leaf details · White tiers · 25th anniversary','wedding',150,'https://images.pexels.com/photos/17869890/pexels-photo-17869890.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('wed4','Classic Ivory Wedding','Single tier · Ivory fondant · Gold leaf details','wedding',120,'https://images.pexels.com/photos/28378968/pexels-photo-28378968.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('bday1','Chocolate Celebration','Dark chocolate sponge · Ganache drip · Strawberry topping','birthday-women',38,'https://images.pexels.com/photos/2337821/pexels-photo-2337821.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,false),
('bday2','Vanilla Party Cake','Classic vanilla · Rainbow sprinkles · Buttercream','birthday-women',32,'https://images.pexels.com/photos/32916204/pexels-photo-32916204.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,false),
('bday3','Red Velvet Party','Red velvet layers · Cream cheese · Festive decor','birthday-women',42,'https://images.pexels.com/photos/9553739/pexels-photo-9553739.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,false),
('bday4','Custom Theme Cake','Your design · Any theme · Personalised message','birthday-women',55,'https://images.pexels.com/photos/5713248/pexels-photo-5713248.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,false),
('avail1','Classic Vanilla Slice','Freshly baked this morning · Light sponge · Buttercream','mini-cake',6,'https://images.pexels.com/photos/1055272/pexels-photo-1055272.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',10,true),
('avail2','Chocolate Fudge Cupcake','Rich cocoa · Ganache topping · Sprinkles','mini-cake',4.5,'https://images.pexels.com/photos/3776947/pexels-photo-3776947.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',20,true),
('avail3','Strawberry Tart','Fresh strawberries · Custard · Flaky pastry','mini-cake',7,'https://images.pexels.com/photos/140831/pexels-photo-140831.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',30,true),
('avail4','Lemon Drizzle Loaf','Zesty lemon · Sugar glaze · Moist sponge','mini-cake',5.5,'https://images.pexels.com/photos/1485806/pexels-photo-1485806.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',40,true),
('avail5','Red Velvet Cookie','Cream cheese chunks · Cocoa · Soft bake','mini-cake',3.5,'https://images.pexels.com/photos/2067396/pexels-photo-2067396.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',50,true),
('avail6','Cinnamon Roll','Warm spice · Cream cheese glaze · Yeast dough','mini-cake',5,'https://images.pexels.com/photos/351961/pexels-photo-351961.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=400&w=400',60,true);
...
ALTER TABLE public.orders
  ADD COLUMN cake_id text REFERENCES public.shop_items(id) ON DELETE SET NULL,
  ADD COLUMN category_id uuid REFERENCES public.shop_categories(id) ON DELETE SET NULL;
CREATE INDEX orders_cake_id_idx ON public.orders(cake_id);
CREATE INDEX orders_category_id_idx ON public.orders(category_id);
...
CREATE POLICY "Admins can insert app settings" ON public.app_settings FOR INSERT TO authenticated WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can update app settings" ON public.app_settings FOR UPDATE TO authenticated USING (public.has_role(auth.uid(), 'admin')) WITH CHECK (public.has_role(auth.uid(), 'admin'));
CREATE POLICY "Admins can delete app settings" ON public.app_settings FOR DELETE TO authenticated USING (public.has_role(auth.uid(), 'admin'));
CREATE TRIGGER update_app_settings_updated_at BEFORE UPDATE ON public.app_settings FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
INSERT INTO public.app_settings (key, value) VALUES ('telegram_username', 'selamcake') ON CONFLICT (key) DO NOTHING;